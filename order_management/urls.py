...
from .views import (
    ...
    PurchasedProductReceivedInUsaOfficeListView,
...
urlpatterns = [
    ...
    path('product_arrived_in_usa_office_list/', PurchasedProductReceivedInUsaOfficeListView, name='product-arrived-in-usa-office-list'),
